...
.nav{max-width:1160px;margin:auto;display:flex;align-items:center;justify-content:space-between;gap:16px;padding:12px 20px;flex-wrap:nowrap}
.brand{display:flex;align-items:center;gap:12px;text-decoration:none;flex:0 0 auto}
.brand img{height:auto;width:clamp(120px, 13vw, 180px);display:block;filter:drop-shadow(0 1px 1px rgba(0,0,0,.25))}
.navlinks{margin-left:auto;display:flex;align-items:center;gap:18px;flex:1 1 auto;justify-content:flex-end;min-width:0}
.navlinks a{color:var(--blue-900);text-decoration:none;font-weight:800;padding:8px 10px;border-radius:10px;font-size:1.05rem;white-space:nowrap}
...
.welcome h1{font-size:clamp(28px,3.2vw,46px);line-height:1.15;margin:0 0 10px;color:var(--coral)}
...
.car-btn{position:absolute;top:50%;transform:translateY(-50%);background:rgba(0,0,0,.55);border:none;color:#fff;width:52px;height:52px;border-radius:50%;cursor:pointer;font-size:28px;line-height:1;display:flex;align-items:center;justify-content:center}
...
/* Services (Claude styles) */
.services-grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(300px,1fr));gap:2rem;margin-top:2rem}
.service-card{background:#fff;padding:2rem;border-radius:15px;box-shadow:0 5px 15px rgba(0,0,0,.1);text-align:center;transition:transform .3s ease, box-shadow .3s ease;border-top:4px solid #E74C3C}
...
.info-card{padding:22px;border:1px solid #eef2f7;border-radius:16px;background:#fff;box-shadow:0 6px 18px rgba(0,0,0,.05)}
...
.foot{max-width:1160px;margin:auto;display:flex;align-items:center;justify-content:space-between;gap:12px;padding:22px 20px}
